...
record <- function(team){
  ...
  team <- cbind(team[, 1:3], team[, c("Wins", "Losses", "Win_per")], team[, -(1:6)])
  
  return(team)}

tie_record <- function(team){
...
GB_2018 <- tie_record(GB_2018)
CLE_2018 <- tie_record(CLE_2018)